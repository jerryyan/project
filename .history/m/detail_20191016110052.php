    ...
    <div class="div1">
        ...
        <div class="time">
            ...
            <select name="" class="select" onchange="self.location.href = options[selectedIndex].value">
                <option value="index.php">项目预约</option>
                <option value="jzchart.php">项目就诊</option>
                <option value="detail.php?type=szyd" <?php if ($type == 'szyd') echo "selected"; ?>>远大</option>
                <option value="detail.php?type=szty" <?php if ($type == 'szty') echo "selected"; ?>>天元</option>
        ...
        <div class="title">
            <span>
                <?php
                $typetext = array("szyd" => '远大',"szty" => '天元',  "zjdd" => '湛江', 'gzdd' => "东大", 'gzma' => '民安', 'nngc' => '南肛', 'nnwc' => '南胃', "szydwc" => '远大胃肠');
    ...
    $(function() {
        ...
        function getmedia(datetime, type) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    var len = data.length;
                    var str = "<table width='84%' border='0' cellspacing='2' cellpadding='0'><tr style='color:#666'><td width='30%'>媒体</td><td width='40%'>预约</td><td width='40%'>就诊</td></tr>";
