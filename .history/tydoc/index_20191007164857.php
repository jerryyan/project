...
<body class="baseSize">
    ...
    <section>
        <div class="row">
            ...
            <?php if ($_SESSION['doctor'] == '深圳天元') { ?>
            <div class="col-xs-12">
                <button type="button" class="btn btn-primary" onclick="location.href='/tydoc/history.php'">登录记录</button>
            </div>
            <?php } ?>
                ...
                <table class="table" style="text-align: center">
                    <thead>
                        <tr>
                            ...
                            <th style="min-width: 75px;text-align: center;">医生</th>
                            <th style="min-width: 75px;text-align: center;">症状</th>
