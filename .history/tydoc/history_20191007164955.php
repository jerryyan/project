...
$all_res = get_fetchAll_assoc($project, 'select * from ty_history');
$count = count($all_res);
//每页显示条数
$page = 10;
$index = ($p - 1) * $page;
$sql = "select * from ty_history order by atime desc limit $index,$page ";
...
<body>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <button type="button" class="btn btn-primary" onclick="location.href='/tydoc/index.php'">返回首页</button>
...
<script>
    ...
    $('#imports').click(function(){
        location.href=`/doc/export.php?begin=${$('#dataTime1').val()}&end=${$('#dataTime2').val()}`
    })
</script>
