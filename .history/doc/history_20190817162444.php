...
<body>
    <div class="container">
        ...
        <div class="col-md-12">
                ...
                <!-- <button type="button" class="btn btn-primary" onclick="location.href='/doc/export.php'">导出记录</button> -->
                <a class="btn btn-primary" href="/doc/export.php" target="view_frame">导出记录</a>
            </div>
