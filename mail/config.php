...
return array(
    ...
    'RBAC_ROLE_TABLE' => 'djxx_role',
    'RBAC_USER_TABLE' => 'djxx_role_user',
    'RBAC_ACCESS_TABLE' => 'djxx_access',
    'RBAC_NODE_TABLE' => 'djxx_node',
    ...
    'DB_NAME' => 'zgdjxx', // 数据库名
    'DB_USER' => 'root', // 用户名
    'DB_PWD' => 'ROOT.mysq12015', // 密码
//    'DB_USER' => 'root', // 用户名
//    'DB_PWD' => 'root', // 密码
    'DB_PORT' => '3306', // 端口
    'DB_PREFIX' => 'djxx_', // 数据库表前缀
);
