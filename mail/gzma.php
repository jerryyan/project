...
$mail->Subject = "{$nowDate}民安数据日报"; //邮件标题 
$mail->FromName = "民安数据日报系统";  //发件人姓名 
...
$contents = <<<EOF
    ...
    <body>
        <div style="text-align: center;font-size: 18px;">{$nowDate}民安数据日报</div>
        <table width="100%" border="1" cellpadding="0" cellspacing="0" align="center" class="tbtitle" style="background:#FBFCE2;margin-bottom:5px;">    
            <tbody>
                ...
                <tr align="center">
                    <td>昨日预约到昨日</td>                
                    <td>$gzma_zrdzr_row</td>                
                </tr>
                <tr align="center">
                    <td>昨日预约到昨日（纯网）</td>   
                    <td>$gzma_zrdzrcw_row</td>             
                </tr>
                <tr align="center">
                    <td>昨日预约昨日就诊</td>              
                    <td>$gzma_jz_row</td>           
                ...
                <tr align="center">
                    <td>昨日就诊(纯网)</td>             
                    <td>$gzma_yjzcw_row</td>              
                </tr>
                            <tr align="center">
                    <td>本月纯网总到诊</td>              
                    <td>$gzma_mjzcw_row</td>                 
                </tr>
            </tbody>
        </table>
           <div>
