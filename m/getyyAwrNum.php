...
$szyd_sql = "select awr,count(awr) as nums,'远大' as gp from info_appointment where (department='肛肠外科' or department='肛肠科') and dr=0 and media in ('百度','QQ','qq','手机网','百度商桥','网站后台预约','SOGU','SOSO','谷歌','商务通转Q','商务通转电话','神马','搜狗','网络其它','360','个人微信') and ts >='{$startDate}' and ts <='{$endDate}' group by awr ";
...
$totalAwkNum = array_merge($zjdd_yy_row, $gzma_yy_row, $szyd_yy_row, $gzdd_yy_row);
