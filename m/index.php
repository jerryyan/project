    ...
    <div class="div1">
        <div class="time">
            ...
            <select name="" class="select" onchange="self.location.href = options[selectedIndex].value">
                <option value="index.php" selected>预约数据</option>
                <option value="jzchart.php">就诊数据</option>
                <option value="detail.php?type=szyd">远大</option>
                <option value="detail.php?type=szty">天元</option>
        ...
        <div class="logo">
            <ul>
                ...
                <li><img src="/images/logo_ty.jpg">天元</li>
            </ul>
        </div>
    </div>
</body>
